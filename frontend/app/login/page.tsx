...
export default function LoginPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // ✅ ไม่ใช้ตัวแปร body รวม — เรียก fetch ตรงๆ แยกกันชัดเจน
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        {isRegister && (
          <div style={{ display: "flex", gap: 12, marginBottom: 12 }}>
            <div style={{ flex: 1 }}>
              ...
              <input
                style={styles.input} name="firstName"
                placeholder="สมชาย" value={form.firstName}
            ...
            <div style={{ flex: 1 }}>
              ...
              <input
                style={styles.input} name="lastName"
                placeholder="ใจดี" value={form.lastName}
                onChange={handleChange} onKeyDown={handleKeyDown}
              />
            </div>
          </div>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <input
            style={styles.input} name="password" type="password"
